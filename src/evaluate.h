...
#define SCORE_ZERO (EvalScore) { 0, 0, 0 }

extern EvalScore PSQT[32][SQUARE_NB];
extern const int Tempo;
extern const int EarlyPhaseArray[33];
extern const int MidPhaseArray[33];
extern const int LatePhaseArray[33];
