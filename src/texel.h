...
#define NTERMS       (     24) // Total terms in the Tuner (647)
...
#define TuneKnightBehindFriendlyPawn    (1)
#define TuneKnightBehindEnemyPawn       (1)
...
#define TuneBishopBehindFriendlyPawn    (1)
#define TuneBishopBehindEnemyPawn       (1)
...
#define EXECUTE_ON_TERMS(fname) do {                            \
    ...
    ENABLE_1(fname, KnightBehindFriendlyPawn, 6, NORMAL);       \
    ENABLE_1(fname, KnightBehindEnemyPawn, 6, NORMAL);          \
    ...
    ENABLE_1(fname, BishopBehindFriendlyPawn, 6, NORMAL);       \
    ENABLE_1(fname, BishopBehindEnemyPawn, 6, NORMAL);          \
