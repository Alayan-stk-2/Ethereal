...
#define NTERMS       (     18) // Total terms in the Tuner (643)
...
#define TuneClosednessPawnAdjustment    (1)
#define TuneClosednessPassedAdjustment  (1)
...
#define EXECUTE_ON_TERMS(fname) do {                            \
    ...
    ENABLE_1(fname, ClosednessPawnAdjustment, 9, NORMAL);       \
    ENABLE_1(fname, ClosednessPassedAdjustment, 9, NORMAL);     \
