...
#define NTERMS       (      2) // Total terms in the Tuner (635)
...
#define TuneThreatRestrictionPiece      (1)
#define TuneThreatRestrictionEmpty      (1)
...
#define EXECUTE_ON_TERMS(fname) do {                            \
    ...
    ENABLE_0(fname, ThreatRestrictionPiece, NORMAL);            \
    ENABLE_0(fname, ThreatRestrictionEmpty, NORMAL);            \
