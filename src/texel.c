...
extern const int ThreatPawnPinnedToQueen[2];
extern const int ThreatKnightPinnedToQueen[2];
extern const int ThreatBishopPinnedToQueen;
extern const int ThreatRookPinnedToQueen;
