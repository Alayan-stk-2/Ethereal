...
extern const int KnightOutpost[2][2][2];
extern const int KnightLowOutpost[2][2][2];
...
extern const int BishopOutpost[2][2][2];
extern const int BishopLowOutpost[2][2][2];
