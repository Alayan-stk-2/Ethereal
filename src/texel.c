...
extern const int KnightBehindFriendlyPawn[6];
extern const int KnightBehindEnemyPawn[6];
...
extern const int BishopBehindFriendlyPawn[6];
extern const int BishopBehindEnemyPawn[6];
