...
const int PawnPSQT32[32] = {
    ...
    S( -22,   2), S(  -2,  -1), S( -14,   1), S( -10,  -4), 
    S( -26,  -1), S( -20,  -1), S( -11,  -9), S(  -8, -17), 
    S( -21,   5), S( -19,   6), S(   6, -15), S(   3, -28), 
    S( -13,   6), S( -12,   3), S( -12, -11), S(  -6, -25), 
    S( -12,  16), S( -12,  12), S(  -7,   4), S(  19, -23), 
    S( -24, -62), S( -70, -29), S(  -3, -42), S(  34, -55), 
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), 
};
...
const int KingPSQT32[32] = {
    S(  46, -78), S(  40, -45), S( -15,  -7), S( -19, -20), 
    S(  36, -29), S(  -3, -15), S( -47,  13), S( -52,  12), 
    S(  10, -28), S(  17, -22), S(  14,   0), S( -11,  16), 
    S(   3, -35), S(  85, -35), S(  42,   4), S(  -6,  24), 
    S(   5, -20), S(  96, -32), S(  47,  10), S(   3,  19), 
    S(  45, -27), S( 120, -23), S(  94,   0), S(  38,  -1), 
    S(   5, -49), S(  46,  -9), S(  31,   5), S(   8,  -3), 
    S(   8,-102), S(  74, -54), S( -20, -14), S( -19, -13), 
};
...
const int KingShelter[2][4][8] = {
  {{S( -12,  -4), S(   8, -23), S(  13,  -4), S(   5,   7), S(  -2,   7), S(   1,   6), S(  -4, -33), S( -34,  15)},
   {S(  17,  -8), S(  14, -15), S(  -6,  -1), S( -18,   4), S( -33,  13), S( -71,  66), S(  91,  81), S( -18,   2)},
   {S(  37,  -7), S(  18,  -9), S( -23,   7), S( -11,  -8), S( -11,  -8), S( -11,   1), S(   0,  65), S( -16,   2)},
   {S(  -2,   7), S(  24, -14), S(   5, -12), S(  14, -17), S(  20, -33), S( -61,   4), S(-136,  51), S(   8,  -7)}},
  {{S(   0,   0), S(  -3, -27), S(   8, -20), S( -35,  14), S( -21,   4), S(   2,  42), S(-167,  -8), S( -36,   6)},
   {S(   0,   0), S(  21, -17), S(   6,  -8), S( -17,  -1), S( -15,  -6), S(  20,  62), S(-184,  -3), S( -34,   6)},
   {S(   0,   0), S(  14,  -7), S( -14,  -3), S(  -2, -15), S(  13,  -9), S( -86,  47), S( -84, -73), S( -23,  -3)},
   {S(   0,   0), S(   1,   5), S(   0,  -3), S(  -9,  -1), S( -16,  -4), S( -98,  31), S(   7, -41), S( -13,  -5)}},
};
