...
void initEval() {
    ...
    for (int sq = 0; sq < SQUARE_NB; sq++) {
        ...
        PSQT[WHITE_KNIGHT][sq] = + KnightValue + KnightPSQT[w32];
        PSQT[WHITE_BISHOP][sq] = + BishopValue + BishopPSQT[w32];
        PSQT[WHITE_ROOK  ][sq] = + RookValue   +   RookPSQT[w32];
        PSQT[WHITE_QUEEN ][sq] = + QueenValue  +  QueenPSQT[w32];
        PSQT[WHITE_KING  ][sq] = + KingValue   +   KingPSQT[w32];

        PSQT[BLACK_PAWN  ][sq] = - PawnValue   -   PawnPSQT[sq2];
        PSQT[BLACK_KNIGHT][sq] = - KnightValue - KnightPSQT[b32];
        PSQT[BLACK_BISHOP][sq] = - BishopValue - BishopPSQT[b32];
        PSQT[BLACK_ROOK  ][sq] = - RookValue   -   RookPSQT[b32];
        PSQT[BLACK_QUEEN ][sq] = - QueenValue  -  QueenPSQT[b32];
        PSQT[BLACK_KING  ][sq] = - KingValue   -   KingPSQT[b32];
    }
}
