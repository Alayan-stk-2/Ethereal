...
const int PassedPawn[2][2][8] = {
  {{S(   0,   0), S( -39,  -1), S( -55,  12), S( -85,  26), S( -10,  11), S(  72, -10), S( 162,  55), S(   0,   0)},
   {S(   0,   0), S( -33,  -1), S( -58,  16), S( -80,  29), S( -17,  31), S(  90,  28), S( 186,  90), S(   0,   0)}},
  {{S(   0,   0), S( -24,   7), S( -53,  10), S( -78,  30), S(  -8,  35), S(  86,  32), S( 257,  98), S(   0,   0)},
   {S(   0,   0), S( -34,   2), S( -52,   9), S( -74,  34), S(  -4,  45), S(  98,  92), S( 162, 240), S(   0,   0)}},
};

const int PassedNoEnemyPasser[8] = {
    S(   0,   0), S(  -3,  26), S(   4,  18), S(   8,  -2), 
    S(   2, -13), S( -17, -22), S( -14, -35), S(   0,   0), 
};
