...
const int PawnPSQT32[32] = {
    ...
    S( -21,   3), S(   1,   0), S( -15,   1), S(  -9,  -5), 
    S( -24,   1), S( -18,   1), S( -12,  -9), S(  -7, -17), 
    S( -18,   6), S( -17,   7), S(   6, -15), S(   3, -27), 
    S( -10,   7), S( -10,   4), S( -13, -10), S(  -7, -25), 
    S(  -9,  20), S(  -9,  17), S(  -6,   7), S(  22, -19), 
    S( -21, -55), S( -68, -22), S(  -1, -36), S(  36, -49), 
    S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), 
};
...
const int PawnIsolated[2] = { S(  -4,  -5), S( -11, -18) };
...
const int PassedPawn[2][2][RANK_NB] = {
  {{S(   0,   0), S( -35,   5), S( -52,  22), S( -78,  29),
    S(  -5,  13), S(  68,  -7), S( 156,  54), S(   0,   0)},
   {S(   0,   0), S( -28,  11), S( -50,  27), S( -72,  33),
    S( -11,  33), S(  88,  31), S( 181,  95), S(   0,   0)}},
  {{S(   0,   0), S( -22,  21), S( -47,  22), S( -70,  33),
    S(  -1,  37), S(  84,  38), S( 259, 105), S(   0,   0)},
   {S(   0,   0), S( -30,  17), S( -45,  19), S( -68,  38),
    S(   0,  50), S(  91, 106), S( 159, 263), S(   0,   0)}},
};
