...
const int KnightMobility[9] = {
    S( -65,-104), S( -28, -94), S( -16, -39), S(  -8, -16), 
    S(   3,  -9), S(   7,   7), S(  15,   9), S(  24,   8), 
    S(  37,  -8), 
};
...
const int BishopMobility[14] = {
    S( -47,-146), S( -28, -88), S( -10, -53), S(  -4, -28), 
    S(   5, -16), S(  12,  -4), S(  14,   5), S(  15,  11), 
    S(  15,  17), S(  20,  17), S(  22,  16), S(  42,   6), 
    S(  42,  18), S(  71, -16), 
};
...
const int RookMobility[15] = {
    S(-149,-113), S( -40,-107), S( -12, -53), S(  -9, -18), 
    S(  -9,  -3), S( -10,  12), S(  -8,  20), S(  -3,  22), 
    S(   3,  28), S(   5,  31), S(   8,  37), S(  13,  39), 
    S(  14,  45), S(  28,  35), S(  80, -10), 
};

/* Queen Evaluation Terms */

const int QueenMobility[28] = {
    S( -61,-263), S(-136,-387), S( -41,-201), S( -15,-191), 
    S(  -6,-137), S(  -4, -81), S(  -1, -48), S(   0, -20), 
    S(   4, -14), S(   5,   6), S(   7,  12), S(   7,  26), 
    S(   9,  23), S(   8,  29), S(   5,  35), S(   2,  38), 
    S(   1,  40), S(  -3,  42), S(  -2,  39), S(  -4,  33), 
    S(   5,  12), S(  20,  -9), S(  26, -37), S(  29, -53), 
...
void initEvalInfo(EvalInfo *ei, Board *board, PKTable *pktable) {
    ...
    ei->mobilityAreas[WHITE] = ~(ei->pawnAttacks[BLACK] | (white & kings) | ei->blockedPawns[WHITE] | (white & pawns & (RANK_2 | RANK_3)));
    ei->mobilityAreas[BLACK] = ~(ei->pawnAttacks[WHITE] | (black & kings) | ei->blockedPawns[BLACK] | (black & pawns & (RANK_7 | RANK_6)));
