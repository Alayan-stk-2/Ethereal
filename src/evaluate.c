...
const int KnightMobility[9] = {
    S( -67,-104), S( -34, -95), S( -16, -41), S(  -7, -16), 
    S(   5,  -9), S(  10,   9), S(  18,  11), S(  27,  10), 
    S(  40,  -8), 
};
...
const int BishopMobility[14] = {
    S( -58,-147), S( -29, -93), S( -12, -50), S(  -2, -27), 
    S(   8, -15), S(  17,  -2), S(  20,   8), S(  21,  14), 
    S(  20,  21), S(  26,  21), S(  27,  20), S(  48,  10), 
    S(  44,  20), S(  71, -16), 
};
...
const int RookMobility[15] = {
    S(-158,-114), S( -47,-108), S( -14, -58), S(  -8, -22), 
    S( -10,  -5), S(  -8,  12), S(  -7,  21), S(  -1,  25), 
    S(   6,  29), S(   9,  34), S(  12,  40), S(  19,  42), 
    S(  19,  48), S(  34,  39), S(  90, -10), 
};

/* Queen Evaluation Terms */

const int QueenMobility[28] = {
    S( -61,-263), S(-169,-387), S( -49,-201), S( -17,-192), 
    S(  -7,-138), S(  -4, -82), S(   0, -48), S(   1, -19), 
    S(   5, -14), S(   6,   8), S(  10,  12), S(  10,  26), 
    S(  12,  20), S(  13,  29), S(  11,  33), S(   6,  37), 
    S(   5,  38), S(  -1,  40), S(   0,  37), S(  -3,  32), 
    S(   4,  10), S(  20, -11), S(  25, -39), S(  28, -54), 
...
void initEvalInfo(EvalInfo *ei, Board *board, PKTable *pktable) {
    ...
    ei->mobilityAreas[WHITE] = ~(ei->pawnAttacks[BLACK] | (white & kings) | ei->blockedPawns[WHITE] | (white & pawns & RANK_2));
    ei->mobilityAreas[BLACK] = ~(ei->pawnAttacks[WHITE] | (black & kings) | ei->blockedPawns[BLACK] | (black & pawns & RANK_7));
