...
const int KingShelter[2][8][8] = {
  {{S( -11,   0), S(  10, -26), S(  20,  -9), S(  12,   4), S(   6,   4), S(   1,   2), S(  -3, -33), S( -45,  20)},
   {S(  20, -10), S(  14, -12), S(  -8,  -2), S( -18,   4), S( -33,  15), S( -70,  68), S(  91,  82), S(  -2,  -2)},
   {S(  39,  -8), S(  16, -10), S( -28,   6), S( -13,  -8), S( -20,  -4), S( -11,   1), S(   0,  66), S( -10,   0)},
   {S(   4,   7), S(  30, -16), S(  -2,  -8), S(   2, -15), S(  19, -36), S( -58,   5), S(-136,  52), S(  -2,  -4)},
   {S(  -8,   4), S(   7,  -6), S( -23,   0), S( -14,   5), S( -20,  -6), S( -42,  -1), S(  33, -17), S(  -2,   1)},
   {S(  41, -17), S(  20, -17), S( -25,   4), S( -14, -16), S(   5, -24), S(  17, -21), S(  41, -30), S( -28,   4)},
   {S(  36, -20), S(   6, -16), S( -22,   0), S( -19,  -4), S( -30,  -7), S( -36,  32), S(   0,  44), S( -17,   3)},
   {S(  -8, -14), S(   8, -19), S(   6,   2), S(  -5,  11), S( -13,  15), S(  -9,  37), S(-190,  87), S( -17,  16)}},
  {{S(   0,   0), S(  -8, -24), S(  10, -19), S( -40,  16), S( -22,   2), S(   3,  42), S(-167,  -8), S( -43,  11)},
   {S(   0,   0), S(  19, -21), S(   5,  -8), S( -18,  -1), S(  -1, -12), S(  26,  66), S(-184,  -3), S( -35,   3)},
   {S(   0,   0), S(  22,  -9), S(   2, -10), S(   0, -20), S(   7,  -7), S( -87,  47), S( -84, -73), S(  -8,  -4)},
   {S(   0,   0), S(  -3,   5), S(  -3,  -5), S( -18,   2), S( -27,   1), S( -99,  31), S(   7, -41), S( -12,  -2)},
   {S(   0,   0), S(  23,  -2), S(   8,  -7), S(   2, -11), S(   6, -26), S( -57,  15), S(-104, -61), S(  -5,   2)},
   {S(   0,   0), S(   7, -10), S( -17,  -3), S( -27,  -6), S(  17, -24), S( -38,   3), S(  55,  38), S( -11,  -4)},
   {S(   0,   0), S(  26, -18), S(  14, -16), S( -11,  -4), S( -28,   9), S(  -9,  15), S( -56, -49), S( -36,  14)},
   {S(   0,   0), S(  13, -38), S(  19, -27), S( -18,  -4), S( -18,  18), S(  -5,  20), S(-228, -55), S( -22,   1)}},
};

const int KingStorm[2][4][8] = {
  {{S(  -7,  26), S( 113, -12), S( -23,  26), S( -21,  10), S( -13,   2), S(  -4,  -4), S(  -9,   0), S( -23,  -1)},
   {S(  -5,  49), S(  57,   5), S( -19,  23), S(  -3,  11), S(  -4,   5), S(   7,  -5), S(   4,  -3), S( -22,   3)},
   {S(   7,  35), S(  15,  17), S( -20,  17), S( -10,   7), S(  -1,   3), S(   4,  -1), S(   0,   2), S(   3,  -2)},
   {S(  -3,  24), S(  12,  15), S( -18,   6), S( -19,   2), S( -20,   4), S(  13, -12), S(  11, -10), S( -18,   2)}},
  {{S(   0,   0), S( -15, -16), S( -25,   4), S(  14, -13), S(  15,  -7), S(   3, -16), S(  -1,  -1), S(  17,  29)},
   {S(   0,   0), S( -16, -34), S(  -1,  -5), S(  40,  -8), S(   2,  -2), S(  16, -20), S(  -7, -10), S( -18,   2)},
   {S(   0,   0), S( -28, -49), S( -26,  -3), S(  19, -11), S(   8,  -1), S( -10, -12), S( -13, -15), S( -11,   6)},
   {S(   0,   0), S(  -2, -18), S( -16, -14), S( -10,  -5), S(  -7,  -3), S(   2, -22), S(  72, -11), S(  13,  20)}},
};
