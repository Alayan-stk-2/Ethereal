...
const int RookPSQT32[32] = {
    S( -14, -30), S( -17, -22), S(  -6, -26), S(   2, -31), 
    S( -53, -16), S( -15, -34), S( -10, -33), S(   0, -36), 
    S( -30, -17), S(  -9, -14), S( -18, -19), S(  -3, -27), 
    S( -22,  -5), S( -12,   1), S(  -9,  -4), S(   2,  -9), 
    S(  -9,   2), S(   9,  -1), S(  18,  -5), S(  33, -10), 
    S( -19,  12), S(  21,  -2), S(  -4,  12), S(  29,  -6), 
    S(  -5,   0), S( -23,  10), S(   3,  -2), S(  19,  -1), 
    S(  30,  15), S(  21,  18), S(   4,  23), S(  15,  19), 
};

const int QueenPSQT32[32] = {
    S(  27, -55), S(   6, -42), S(  12, -52), S(  16, -37), 
    S(  12, -40), S(  24, -58), S(  26, -71), S(  16, -29), 
    S(   8, -26), S(  22, -25), S(   5,  -3), S(   6,  -9), 
    S(   9, -11), S(  11,   9), S(  -2,  10), S( -16,  46), 
    S( -10,  11), S(  -8,  33), S( -18,  12), S( -33,  59), 
    S( -28,  24), S( -20,  13), S( -29,  14), S( -17,  16), 
    S(  -9,  22), S( -64,  56), S( -13,   7), S( -47,  45), 
    S( -14,  12), S(  13,   3), S(   5,   3), S(  -9,  14), 
};

const int KingPSQT32[32] = {
    S(  43, -73), S(  40, -44), S( -11,  -6), S( -26, -13), 
    S(  31, -24), S(  -4, -13), S( -38,  13), S( -51,  15), 
    S(   8, -26), S(  14, -21), S(  16,   2), S( -11,  18), 
    S(   4, -35), S(  85, -36), S(  43,   5), S(  -5,  26), 
    S(   5, -20), S(  97, -33), S(  49,  10), S(   5,  20), 
    S(  45, -30), S( 121, -25), S(  95,   0), S(  39,   0), 
    S(   4, -54), S(  46, -12), S(  31,   2), S(   8,  -6), 
    S(   7,-106), S(  73, -58), S( -21, -18), S( -19, -15), 
};
...
const int KnightMobility[9] = {
    S( -74,-104), S( -31, -96), S( -17, -41), S(  -7, -17), 
    S(   4,  -9), S(   9,   6), S(  16,   9), S(  26,   9), 
    S(  38,  -6), 
};
...
const int BishopMobility[14] = {
    S( -65,-147), S( -31, -95), S( -13, -54), S(  -4, -27), 
    S(   6, -17), S(  14,  -4), S(  17,   5), S(  18,  10), 
    S(  18,  16), S(  22,  17), S(  23,  17), S(  42,   6), 
    S(  42,  18), S(  71, -15), 
};
...
const int RookMobility[15] = {
    S(-148,-113), S( -52,-113), S( -15, -60), S(  -8, -20), 
    S(  -8,  -1), S(  -9,  13), S(  -8,  23), S(  -2,  26), 
    S(   5,  29), S(   8,  33), S(  10,  39), S(  16,  42), 
    S(  16,  46), S(  29,  37), S(  80,  -7), 
};
...
const int QueenMobility[28] = {
    ...
    S(  -1,-139), S(   1, -84), S(   5, -51), S(   5, -22), 
    S(   9, -15), S(  10,   7), S(  13,  13), S(  13,  28), 
    S(  15,  22), S(  16,  31), S(  13,  35), S(  10,  39), 
    S(   9,  41), S(   1,  43), S(   3,  40), S(  -2,  35), 
    S(   6,  14), S(  21,  -8), S(  26, -36), S(  29, -52), 
