...
const int KnightMobility[9] = {
    S( -75,-105), S( -41, -96), S( -27, -43), S( -17, -19), 
    S(  -6, -11), S(  -1,   4), S(   7,   7), S(  16,   7), 
    S(  27,  -8), 
};
...
const int BishopMobility[14] = {
    S( -71,-148), S( -43, -92), S( -23, -53), S( -14, -28), 
    S(  -4, -18), S(   4,  -6), S(   6,   4), S(   8,   9), 
    S(   6,  14), S(  10,  15), S(  11,  15), S(  29,   3), 
    S(  39,  13), S(  68, -23), 
};
...
const int RookMobility[15] = {
    S(-149,-113), S( -62,-113), S( -25, -62), S( -18, -25), 
    S( -18,  -8), S( -19,   6), S( -18,  16), S( -13,  19), 
    S(  -6,  22), S(  -3,  26), S(  -1,  31), S(   4,  34), 
    S(   4,  39), S(  19,  28), S(  84, -20), 
};

/* Queen Evaluation Terms */

const int QueenMobility[28] = {
    S( -61,-263), S(-210,-387), S( -56,-201), S( -18,-192), 
    S(  -7,-138), S(  -5, -80), S(  -1, -50), S(  -2, -20), 
    S(   3, -18), S(   3,  -1), S(   6,   2), S(   6,  16), 
    S(   8,   9), S(   9,  16), S(   6,  19), S(   4,  21), 
    S(   2,  23), S(  -6,  25), S(  -5,  22), S( -10,  16), 
    S(  -3,  -5), S(  12, -29), S(  14, -55), S(  22, -70), 
    S(   6, -80), S(  20,-105), S( -57, -40), S( -33, -64), 
};
